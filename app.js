...
const S = {
  ...
  hdr:          { background:"linear-gradient(135deg,#1a7a3a,#228844)", borderBottom:"2px solid #1a6a30", padding:"16px 24px", display:"flex", alignItems:"center", gap:14, position:"sticky", top:0, zIndex:20, borderRadius:"0 0 0 0" },
  htitle:       { fontSize:22, fontWeight:700, color:"#ffffff", letterSpacing:1 },
  hsub:         { fontSize:11, color:"#b8f0c8", letterSpacing:2 },
  rstBtn:       { background:"rgba(255,255,255,.2)", border:"1px solid rgba(255,255,255,.4)", color:"#fff", borderRadius:6, padding:"6px 12px", cursor:"pointer", fontSize:17, fontFamily:"monospace" },
  ...
  card:         { display:"flex", justifyContent:"space-between", alignItems:"center", background:"#ffffff", border:"1px solid #d8ead8", borderRadius:12, padding:"13px 16px", marginBottom:8, boxShadow:"0 1px 4px rgba(0,0,0,.05)", cursor:"pointer", transition:"box-shadow .15s" },
  ...
  hTime:        { fontSize:10, color:"#9aba9a", marginBottom:5, letterSpacing:1 },
  ...
  updateDate:   { fontSize:16, fontWeight:700, color:"#5a4a10", marginTop:2 },
  ...
  modal:        { background:"#ffffff", border:"2px solid #e07070", borderRadius:16, padding:"26px 22px", maxWidth:380, width:"100%", boxShadow:"0 8px 32px rgba(0,0,0,.15)" },
